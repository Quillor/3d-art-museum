...
export function buildStyles() {
  ...
  S.greek = {
    ceilH: 5.6,
    wall: surf(T.marble("#e6dfd0", "rgba(125,118,105,0.22)", 41), "gloss"), wallUV: 4,
    floor: surf(T.checkerFloor("#d8cdb4", "#4a443c", 42), "gloss"), floorUV: 4,
    ceiling: flat(0xcfc7b6),
    band: { mat: surf(T.meanderBand("#2a2e38", "#d9cfb8", 43), "satin"), y: 4.6, h: 0.55, uvLen: 4 },
  ...
  S.gothic = {
    ceilH: 6.4,
    wall: surf(T.stoneBlocks({ base: "#6a6258", mortar: "#3c372f", rows: 5, cols: 3, seed: 44 }), "satin"), wallUV: 4,
    floor: surf(T.stoneFloor("#5d564b", 45), "satin"), floorUV: 4,
  ...
  S.renaissance = {
    ceilH: 5.4,
    wall: surf(T.plaster("#cbb794", 46)), wallUV: 5,
    floor: surf(T.woodFloor("#6e5335", 47), "satin"), floorUV: 4,
    ceiling: surf(T.coffered("#5d4526", "#3a2c1a", "#c9a256", 48), "satin"), ceilUV: 5.4,
  ...
  S.baroque = {
    ceilH: 5.4,
    wall: surf(T.plaster("#5e1f1d", 49), "satin"), wallUV: 5,
  ...
  S.salon = {
    ceilH: 5.2,
    wall: surf(T.plaster("#5c6248", 52)), wallUV: 5,
    floor: surf(T.woodFloor("#6e5335", 53), "satin"), floorUV: 4,
  ...
  S.salon2 = {
    ...
    floor: surf(T.woodFloor("#7a6247", 55), "satin"), floorUV: 4,
    ceiling: flat(0xd8d2c4),
  ...
  S.modern = {
    ceilH: 4.8,
    wall: surf(T.plaster("#e8e6e1", 56)), wallUV: 6,
    floor: surf(T.concreteFloor(57), "satin"), floorUV: 5,
  ...
  S.meso = {
    ceilH: 5.2,
    wall: surf(T.stoneBlocks({ base: "#9b8a6d", mortar: "#5c5140", rows: 4, cols: 2, seed: 58 })), wallUV: 4,
    floor: surf(T.stoneFloor("#8a7a5f", 59), "satin"), floorUV: 4,
    ceiling: flat(0x6e6250),
    band: { mat: surf(T.grecaBand("#7d5b3f", "#2e2013", 60)), y: 4.2, h: 0.7, uvLen: 5 },
  ...
  S.inca = {
    ceilH: 4.8,
    wall: surf(T.stoneBlocks({ base: "#8d8a80", mortar: "#44423c", rows: 3, cols: 2, seed: 61, jitterCol: 10 }), "satin"), wallUV: 3.5,
  ...
  S.adobe = {
    ceilH: 4.4,
    wall: surf(T.earthenWall("#b98d5f", "#4d3524", 63)), wallUV: 5,
  ...
  S.mesopotamia = {
    ceilH: 5.4,
    wall: surf(T.mudbrick(70)), wallUV: 4,
    floor: surf(T.stoneFloor("#8d7150", 71), "satin"), floorUV: 4,
    ceiling: flat(0x77603f),
    band: { mat: surf(T.glazedBand("#1c4d7c", "#e8c95f", 72), "polished"), y: 4.1, h: 0.9, uvLen: 6 },
  ...
  S.persia = {
    ceilH: 6.0,
    wall: surf(T.stoneBlocks({ base: "#b09a72", mortar: "#6b5b40", rows: 4, cols: 2, seed: 73 })), wallUV: 4,
    floor: surf(T.stoneFloor("#9c8760", 74), "satin"), floorUV: 4,
    ceiling: flat(0x8a7550),
    band: { mat: surf(T.glazedBand("#27516e", "#d8b44e", 75), "polished"), y: 4.7, h: 0.8, uvLen: 6 },
  ...
  S.islamic = {
    ceilH: 5.8,
    wall: surf(T.plaster("#e3d7bd", 76)), wallUV: 5,
    floor: surf(T.stoneFloor("#7d6f58", 77), "satin"), floorUV: 4,
    ceiling: flat(0x39546b),
    band: { mat: surf(T.starTile("#1d4e6b", "#e4d9b8", "#3f8ea6", 78), "polished"), y: 3.9, h: 1.15, uvLen: 2.3 },
  ...
  S.ottoman = {
    ceilH: 5.8,
    wall: surf(T.plaster("#ece5d2", 79)), wallUV: 5,
    floor: surf(T.checkerFloor("#c9bda2", "#5c4f42", 80), "gloss"), floorUV: 4,
    ceiling: flat(0x7c3b3b),
    band: { mat: surf(T.starTile("#7c1f2a", "#e8ddc2", "#27516e", 81), "polished"), y: 3.9, h: 1.0, uvLen: 2 },
  ...
  S.indus = {
    ceilH: 4.6,
    wall: surf(T.mudbrick(82)), wallUV: 3.5,
  ...
  S.china = {
    ceilH: 5.4,
    wall: surf(T.plaster("#8f2b1e", 84), "satin"), wallUV: 5,
    floor: surf(T.woodFloor("#4a3220", 85), "satin"), floorUV: 4,
  ...
  S.khmer = {
    ceilH: 5.2,
    wall: surf(T.stoneBlocks({ base: "#7e7a6a", mortar: "#4a473c", rows: 4, cols: 2, seed: 86 }), "satin"), wallUV: 4,
  ...
  S.japan = {
    ceilH: 4.6,
    wall: surf(T.shoji(89)), wallUV: 4.6,
    floor: surf(T.woodFloor("#9a7d58", 90), "satin"), floorUV: 4,
  ...
  S.mughal = {
    ceilH: 5.8,
    wall: surf(T.marble("#ece2d2", "rgba(150,130,110,0.2)", 92), "gloss"), wallUV: 4,
  ...
  S.egypt = {
    ceilH: 5.8,
    wall: surf(T.stoneBlocks({ base: "#c2a06c", mortar: "#7a6440", rows: 3, cols: 2, seed: 95 })), wallUV: 4,
    floor: surf(T.stoneFloor("#a88c5e", 96), "satin"), floorUV: 4,
    ceiling: flat(0x8a7040),
    band: { mat: surf(T.hieroglyphBand("#c8a86a", "#3a2c18", 97)), y: 2.9, h: 1.5, uvLen: 6, behindArt: true },
  ...
  S.sahel = {
    ceilH: 4.8,
    wall: surf(T.earthenWall("#a5714a", "#4d3524", 98)), wallUV: 5,
    floor: surf(T.dirtFloor(99)), floorUV: 5,
    ceiling: surf(T.woodFloor("#5c452c", 100)), ceilUV: 4,
    band: { mat: surf(T.triangleBand("#96653f", "#e0c27d", "#2e1d10", 101)), y: 3.9, h: 0.55, uvLen: 4 },
  ...
  S.earthen = {
    ...
    band: { mat: surf(T.triangleBand("#7c4a2a", "#e0c27d", "#2e1d10", 105)), y: 1.0, h: 0.4, uvLen: 4 },
