...
function verifierPrompt(r, w) {
  ...
  return [
    ...
    '3. Score fidelity 1–10 per the rubric in OVERNIGHT_QUALITY_PROMPT.md. EXCELLENT (>=9) requires ALL of: era identifiable from silhouette; portal/support/ceiling/signature ornament present and correct; palette+material+lighting match the concept (NOT flat, procedural-default, muddy, or too dark); no clipping / z-fighting / doorway-block; no console errors; art unobstructed. (Remember the light-wall/neighbour calibration above — do not dock for those.)',
