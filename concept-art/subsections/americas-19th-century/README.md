# The Americas 19th Century Asset Spec

**Period:** 1830-1890  
**Gallery read:** Salon/historicist gallery  
**Core material language:** painted plaster, dark wood, parquet
...
## Floor Texture Audit
Shared Renaissance wood floor is too generic; use varnished plank/parquet for 19th-century museum rooms.

## Seamless Texture Exports
These concept textures are tileable and intended as source/reference maps for Blender materials:
- `textures/floor_varnished_parquet_seamless.png`
- `textures/gilt_salon_trim_band_seamless.png`
- `textures/wallpaper_late_federal_salon_seamless.png`
