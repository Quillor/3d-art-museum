# Faith & Living Traditions Asset Spec

**Period:** 1200-1950  
**Gallery read:** earthen/wood ritual gallery  
**Core material language:** earth plaster, carved wood, woven mats
...
## Floor Texture Audit
Dirt floor is acceptable; include woven mat floor asset as an alternate.

## Seamless Texture Exports
These concept textures are tileable and intended as source/reference maps for Blender materials:
- `textures/carved_dark_wood_seamless.png`
- `textures/floor_woven_mat_seamless.png`
