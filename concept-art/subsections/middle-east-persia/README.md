# Persia & Classical East Asset Spec

**Period:** 550 BCE-630 CE  
**Gallery read:** Achaemenid stone hall  
**Core material language:** limestone, relief stone, polished paving
...
## Floor Texture Audit
Stone floor is correct; use large pale limestone slabs rather than random blocks.
