# Islamic Golden Age Asset Spec

**Period:** 650-1500  
**Gallery read:** zellige and plaster gallery  
**Core material language:** zellige tile, carved plaster, stone/marble
...
## Floor Texture Audit
Stone floor acceptable; patterned stone or zellige border is more accurate.

## Seamless Texture Exports
These concept textures are tileable and intended as source/reference maps for Blender materials:
- `textures/floor_marble_zellige_border_seamless.png`
- `textures/wall_carved_plaster_seamless.png`
- `textures/zellige_star_tile_seamless.png`
